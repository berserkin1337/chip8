...
Chip8::Chip8() {
    ...
    // initialize the index register of the Chip8 which is 2 bytes. It points to
    ...
    // initialize the graphics of the Chip8 which is 64x32 pixels of black and
    // white
...
bool Chip8::is_running() { return !closed; }
